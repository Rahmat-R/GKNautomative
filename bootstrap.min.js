...
*/
	return a(document).on(n.CLICK_DATA_API,q.DATA_TOGGLE,function(b){
		b.preventDefault();
		var $trigger = a(this)
		var selector = f.getSelectorFromElement(this)
		a(selector).each(function () {
			const $target = a(this);
			const data    = $target.data('bs.collapse');
			const config  = data ? 'toggle' : $trigger.data();
			r._jQueryInterface.call($target, config);
		})
	}),
